...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organizacion.municipio'
        db.add_column('encuesta_organizacion', 'municipio', self.gf('django.db.models.fields.related.ForeignKey')(default=5525, to=orm['lugar.Municipio']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organizacion.municipio'
        db.delete_column('encuesta_organizacion', 'municipio_id')
