...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Pregunta.texto_explicativo'
        db.delete_column('encuesta_pregunta', 'texto_explicativo')

        # Changing field 'Pregunta.titulo'
        db.alter_column('encuesta_pregunta', 'titulo', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Opcion.titulo'
        db.alter_column('encuesta_opcion', 'titulo', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # We cannot add back in field 'Pregunta.texto_explicativo'
        raise RuntimeError(
            "Cannot reverse this migration. 'Pregunta.texto_explicativo' and its values cannot be restored.")

        # Changing field 'Pregunta.titulo'
        db.alter_column('encuesta_pregunta', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Opcion.titulo'
        db.alter_column('encuesta_opcion', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=200))
